package com.example.user.mainintroscreens;
 ...
 */
public class InterfaceIndicator {
         ...
         * <p/>
         * {@link InterfaceIndicator#initialize(int)} is called after this.
         *
    ...
    // View newInstance(@NonNull Context context);
         ...
         * As with {@link InterfaceIndicator#newInstance(Context)}, this method is only called once for each creation of
         * the activity as well.
         * <p/>
         * {@link InterfaceIndicator#newInstance(Context)} is called before this.
         *
